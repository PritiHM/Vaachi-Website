      ...
      <div className="grid grid-cols-1 md:grid-cols-[60%_40%] gap-10 items-start">
        ...
        <div className="flex flex-row items-start gap-8">
          <div className="flex flex-col items-center gap-2">
            <img src="/images/envelope.png" className="w-10 h-10 md:w-12 md:h-12" />
            <a
              href="mailto:contact@vaachi.org"
              className={`${fraunces.className} text-[15px] md:text-[17px] hover:underline`}
            >
              contact@vaachi.org
            </a>
          </div>
          ...
          <div className="flex flex-col items-center gap-2">
            <img src="/images/phone.png" className="w-10 h-10 md:w-12 md:h-12" />
            <a
