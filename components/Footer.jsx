  ...
  return (
    <footer className="w-full bg-[#F7F6F1] text-[#291F1E]">
      <div className="w-full border-t border-gray-200">
        <div className="w-full max-w-7xl mx-auto mt-5 md:mt-10 lg:mt-20 px-4 md:px-0 py-6 md:py-10 grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
          ...
          <div className="flex flex-col items-center md:items-center gap-2 order-3 md:order-2 md:col-start-2 text-center">
            <Link
              href="/privacy"
              className="text-sm md:text-xl hover:underline font-bold"
            >
              Privacy Policy
            </Link>
            <Link
          ...
          <div className="flex flex-col items-center md:items-end gap-2 order-2 md:order-3 md:col-start-3 md:justify-end">
            <div className="flex items-center gap-4 md:gap-5">
              <Link
                href="https://www.linkedin.com/company/vaachi-foundation"
                target="_blank"
              ...
              <Link
                href="https://www.youtube.com/@vaachi-foundation"
                target="_blank"
                rel="noopener noreferrer"
              >
                <Image
