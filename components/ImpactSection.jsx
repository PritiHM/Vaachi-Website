  ...
  return (
    <>
      ...
      <section className="section pt-6 md:pt-10 pb-0 md:pb-10 w-full max-w-7xl mx-auto px-3 md:px-0 ">
        ...
        <p
          className={`${fraunces.className} text-base text-[#291F1E] max-w-[900px] mt-2 mb-6`}
        >
          Through curated performances, workshops, and collaborations, we weave
          art with purpose:
        </p>
            ...
            >
              <div className="flex flex-col items-start">
                ...
                <h3
                  className={`${
                    fraunces.className
                  } mt-3 text-[24px] leading-[36px] font-bold ${
                ...
                <p
                  className={`${
                    fraunces.className
                  } text-[16px] leading-[24px] mt-1 max-w-[340px] ${
                    activePoint === idx ? "text-[#00656D]" : "text-[#333333]/70"
                  }`}
                >
                  {p.desc}
        ...
        <div className="lg:hidden mb-6 mt-8">
          <div className="flex flex-col items-start gap-3">
            ...
            <h3
              className={`${fraunces.className} text-[24px] leading-[32px] font-bold text-[#00656D]`}
            >
              {current.title}
            </h3>

            <p
              className={`${fraunces.className} text-[16px] leading-[24px] text-[#00656D]`}
            >
              {current.desc}
            </p>
          </div>
