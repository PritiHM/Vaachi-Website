...
export default function Header() {
  return (
    <header className="w-full h-[70px] bg-[#F7F6F1] sticky top-0 z-40 border-b">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-0 py-3 flex items-center justify-between">
        ...
        <nav className="hidden md:flex gap-6 items-center">
          <a
            href="#contact"
            className="font-bold text-lg sm:text-xl text-[#00656D] transition hover:underline"
          >
            Join Waitlist
          </a>
        </nav>
